...
int main()
{
	...
	// stateless lambda 
	auto IsLargerThan { [] (int value1, int value2) {return value1 > 100 && value2 > 100;}};
	...
	// statefull lambda
	int M_VALUE = 100;
	auto IsLargerThanVersionB { [M_VALUE] (int value1, int value2) {return value1 > M_VALUE && value2 > M_VALUE;}};
	findMatches(values1, values2, IsLargerThanVersionB, printMatch);
